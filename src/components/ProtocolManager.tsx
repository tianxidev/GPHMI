import { Plus, Trash2, Edit2, Download, Upload, FileCode } from "lucide-react";
        ...
        <Drawer open={isOpen} onOpenChange={onOpenChange}>
            ...
            <DrawerContent className="h-[90vh]">
                ...
                <div className="flex">
                        ...
                        <ScrollArea className="flex-1 mt-4">
                            <div className="space-y-2">
                                {protocols.map((protocol) => (
                                    <div
                                        key={protocol.id}
                                        className={`p-3 border rounded-lg space-y-2 cursor-pointer transition-colors ${selectedProtocol?.id === protocol.id
                                            ? "bg-accent"
                                            : "hover:bg-accent/50"
                                            }`}
                    ...
                    {/* right */}
                    <div className="flex-1 p-4 flex flex-col h-full border-l">
                        {selectedProtocol ? (
                            <>
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="edit-description">{t("protocol.description")}</Label>
                                        <Input
                                            id="edit-description"
                                        ...
                                        <div className="flex gap-4">
                                            <div className="flex items-center space-x-2">
                                                <input
                                                    type="radio"
                                                    id="active"
                                                    checked={selectedProtocol.registration.type === 'active'}
                                                    onChange={() =>
                                                        setSelectedProtocol((prev) =>
                                                            prev ? {
                                                                ...prev,
                                                ...
                                                />
                                                <Label htmlFor="active">{t("protocol.registration.active")}</Label>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <input
                                                    type="radio"
                                                    id="passive"
                                                    checked={selectedProtocol.registration.type === 'passive'}
                                                    onChange={() =>
                                                        setSelectedProtocol((prev) =>
                                                            prev ? {
                                                                ...prev,
                                                ...
                                                />
                                                <Label htmlFor="passive">{t("protocol.registration.passive")}</Label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {selectedProtocol.registration.type === 'active' ? (
                                        <>
                                            <div className="space-y-2">
                                                <Label htmlFor="edit-command">{t("protocol.registration.command")}</Label>
                                                <Input
                                                    id="edit-command"
                                                    value={selectedProtocol.registration.active?.command || ""}
                                                    onChange={(e) =>
                                                        setSelectedProtocol((prev) =>
                                                            prev ? {
                                                                ...prev,
                                            ...
                                            <div className="space-y-2">
                                                <Label htmlFor="edit-expected-response">{t("protocol.registration.expectedResponse")}</Label>
                                                <Input
                                                    id="edit-expected-response"
                                                    value={selectedProtocol.registration.active?.expectedResponse || ""}
                                                    onChange={(e) =>
                                                        setSelectedProtocol((prev) =>
                                                            prev ? {
                                                                ...prev,
                                                ...
                                                <div className="flex gap-4">
                                                    <div className="flex items-center space-x-2">
                                                        <input
                                                            type="radio"
                                                            id="content"
                                                            checked={selectedProtocol.registration.passive?.matchType === 'content'}
                                                            onChange={() =>
                                                                setSelectedProtocol((prev) =>
                                                                    prev ? {
                                                                        ...prev,
                                                        ...
                                                        />
                                                        <Label htmlFor="content">{t("protocol.registration.content")}</Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <input
                                                            type="radio"
                                                            id="ip"
                                                            checked={selectedProtocol.registration.passive?.matchType === 'ip'}
                                                            onChange={() =>
                                                                setSelectedProtocol((prev) =>
                                                                    prev ? {
                                                                        ...prev,
                                                        ...
                                                        />
                                                        <Label htmlFor="ip">{t("protocol.registration.ip")}</Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <input
                                                            type="radio"
                                                            id="ipRange"
                                                            checked={selectedProtocol.registration.passive?.matchType === 'ipRange'}
                                                            onChange={() =>
                                                                setSelectedProtocol((prev) =>
                                                                    prev ? {
                                                                        ...prev,
                                                        ...
                                                        />
                                                        <Label htmlFor="ipRange">{t("protocol.registration.ipRange")}</Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="space-y-2">
                                                <Label htmlFor="edit-match-pattern">{t("protocol.registration.matchPattern")}</Label>
                                                <Input
                                                    id="edit-match-pattern"
                                                    value={selectedProtocol.registration.passive?.matchPattern || ""}
                                                    onChange={(e) =>
                                                        setSelectedProtocol((prev) =>
                                                            prev ? {
                                                                ...prev,
                                                    ...
                                                    placeholder={
                                                        selectedProtocol.registration.passive?.matchType === 'content'
                                                            ? t("protocol.registration.contentPatternPlaceholder")
                                                            : selectedProtocol.registration.passive?.matchType === 'ip'
