...
const resources = {
    en: {
        translation: {
            ...
            "protocol.select": "Select a protocol to edit",
            "protocol.example": "// Example protocol handler\nfunction(data) {\n  // Process the data\n  return {\n    type: 'data',\n    value: data\n  };\n}",
            ...
            "protocol.registration.contentPatternPlaceholder": "Enter content pattern to match",
            "protocol.registration.ipPatternPlaceholder": "Enter IP address (e.g., 192.168.1.100)",
            "protocol.registration.ipRangePatternPlaceholder": "Enter IP range (e.g., 192.168.1.1-192.168.1.255)",
    ...
    zh: {
        translation: {
            ...
            "protocol.select": "选择一个协议进行编辑",
            "protocol.example": "// 协议处理器示例\nfunction(data) {\n  // 处理数据\n  return {\n    type: 'data',\n    value: data\n  };\n}",
            ...
            "protocol.registration.ipPatternPlaceholder": "输入IP地址（例如：192.168.1.100）",
            "protocol.registration.ipRangePatternPlaceholder": "输入IP范围（例如：192.168.1.1-192.168.1.255）",
